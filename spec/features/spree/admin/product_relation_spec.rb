...
RSpec.describe 'Admin Product Relation', :js do
  ...
  let!(:product_relation_type) do
    create(
      :product_relation_type,
      name: 'Related Products'
    )
  end
  let!(:variant_relation_type) do
    create(
  ...
  it 'create relation with product' do
    ...
    within_row(1) do
      ...
      expect(page).to have_field(
        ...
        with: 'Related Products Description'
      )
    end
  end
  ...
  it 'create relation with variant' do
    ...
    within_row(1) do
      ...
      expect(page).to have_field(
        'relation_description',
        with: 'Related Variants Description'
      )
    end
  end
  ...
  context 'with relations' do
    ...
    it 'update description' do
      ...
      within_row(1) do
        expect(page).to have_field(
          'relation_description',
          with: 'Related description updated'
        )
      end
    end
